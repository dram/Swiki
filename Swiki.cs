...
!HttpAdaptor methodsFor: 'post processing'!
...
!HttpAdaptor methodsFor: 'accessing'!
dataTimeout
...
!HttpAdaptor methodsFor: 'dispatching'!
...
!HttpAdaptor methodsFor: 'initialize-release'!
...
!HttpAdaptor class methodsFor: 'timestamp'!
...
!HttpAdaptor class methodsFor: 'bindings'!
current
...
!HttpAdaptor class methodsFor: 'preferences'!
dataTimeout
...
!HttpAdaptor class methodsFor: 'instance creation'!
...
!HttpRequest methodsFor: 'accessing'!
host
...
!KomServicesTests methodsFor: 'as yet unclassified'!
setUp
...
!KomTcpServicesTests methodsFor: 'as yet unclassified'!
setUp
...
!MultipartChunk methodsFor: 'accessing'!
...
!NetworkHost methodsFor: 'accessing'!
nameString
...
!TcpService methodsFor: 'accessing'!
portNumber
...
!TcpService methodsFor: 'initialization'!
...
!TcpService methodsFor: 'startup and shutdown'!
prepareForStartup
	"The squeak system just started up"
	Socket initializeNetwork.! !

!TcpService methodsFor: 'printing'!
printOn: aStream
	super printOn: aStream.
	aStream nextPutAll: ' port: ', self portNumber asString! !

!TcpService methodsFor: 'conversation'!
serve: aSocket
...
!TcpService methodsFor: 'starting and stopping'!
start
...
!TcpService methodsFor: '*KomSBServices'!
itemActionFor: aVisitor

	^aVisitor doKomTcpService: self! !


!HttpService methodsFor: 'error handling'!
...
!HttpService methodsFor: 'initialize-release'!
initialize

	super initialize.
	mode := #deployment.! !

!HttpService methodsFor: 'configuration'!
keepAlive
...
!HttpService methodsFor: 'pluggable'!
...
!HttpService methodsFor: 'startup and shutdown'!
prepareForStartup

	ServerHostName _ nil.
	self class initializeServerType.! !

!HttpService methodsFor: 'serving'!
...
!HttpService methodsFor: 'starting and stopping'!
start

	self class initializeServerType.
	^super start! !

!HttpService methodsFor: '*KomSBHttpServer-operations'!
itemActionFor: aVisitor

	^aVisitor doKomHttpService: self! !


!TcpService class methodsFor: 'class initialization'!
initialize
	"self initialize"

	PortAssignments := Dictionary new.! !

!TcpService class methodsFor: 'instance creation'!
on: portNumber
...
!TcpService class methodsFor: 'accessing'!
...
!HttpService class methodsFor: 'bindings'!
current
...
!HttpService class methodsFor: 'accessing'!
initialize
